...
extension PurchaseService on Purchase {
  Future<Purchase> save() async => YPay.client
          .post(
        '${YPay.baseUrl}/api/v1/wallets/${this.walletId}/purchases',
        headers: {
  ...
  Future<Purchase> confirm() async {
    ...
    return YPay.client.post(
      '${YPay.baseUrl}/api/v1/wallets/${this.walletId}/purchases/${this.id}/confirm',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
      },
  ...
  Future<Purchase> cancel() async {
    ...
    return YPay.client.post(
      '${YPay.baseUrl}/api/v1/wallets/${this.walletId}/purchases/${this.id}/cancel',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
      },
